...
from processing import add_contact, change_contact, get_contact, get_all_contacts
...
def main():
    ...
    while True:
        ...
        try:
            ...
            print(f"{Fore.RED}Oops! Looks like empty command field. Try again...{Fore.RESET}")
